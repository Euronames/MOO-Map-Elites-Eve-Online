...
ON dgmeffects.effectID = c.effectID AND c.typeID IN (SELECT dgmtypeeffects.typeID FROM dgmtypeeffects WHERE effectID = 2663)
/* ----------------------------------------------------------------- */
/* ----------------------------------------------------------------- */
...
/* ----------------------------------------------------------------- */
/* Joins the attributeName from dgmattribs table */
SELECT attributes.attributeName, a.value, a.typeName, a.typeID, a.attributeID
